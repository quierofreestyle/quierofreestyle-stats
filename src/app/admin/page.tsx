...
export default async function AdminPage() {
  ...
  const [competitions, events, draftEvents, openIssues] = await Promise.all([
  ...
  return (
    <>
      ...
      <section className="admin-welcome">
        <p className="eyebrow">Primer corte</p>
        <h2>La base administrativa está activa</h2>
        <p>
          Las próximas pantallas incorporarán la gestión de competencias,
          eventos y las incidencias de la importación histórica.
        </p>
        <dl>
